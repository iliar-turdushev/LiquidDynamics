...
{
   internal sealed class BarotropicComponentZeidelMethodU : BarotropicComponentZeidelMethodBase
   {
      private readonly int[,] _surface;

      internal BarotropicComponentZeidelMethodU(IBarotropicComponentProblem problem, Grid x, Grid y, int[,] surface)
         : base(problem, x, y)
      {
         _surface = surface;
      }
