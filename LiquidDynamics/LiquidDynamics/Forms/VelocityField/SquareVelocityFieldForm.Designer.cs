...
{
   internal partial class SquareVelocityFieldForm
   {
      /// <summary>
      ...
      private void InitializeComponent()
      {
         ...
         this._paletteControl = new PaletteControl();
         this._graphControl = new GraphControl();
         ...
         this.Name = "SquareVelocityFieldForm";
         this.Text = "Поле скоростей";
